*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMM_MV_GOSBOASDT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMM_MV_GOSBOASDT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMM_MV_GOSBOASDT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMM_MV_GOSBOASDT_EXTRACT
TOTAL = ZMM_MV_GOSBOASDT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMM_MV_GOSBOASDT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMM_MV_GOSBOASDT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMM_MV_GOSBOASDT_EXTRACT
TOTAL = ZMM_MV_GOSBOASDT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMM_MV_GOSBOASDT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMM_MV_GOSBOASDT'
...
TOTAL = ZMM_MV_GOSBOASDT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMM_MV_GOSBOASDT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMM_MV_GOSBOASDT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMM_MV_GOSBOASDT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMM_MV_GOSBOASDT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMM_MV_GOSBOASDT_EXTRACT
TOTAL = ZMM_MV_GOSBOASDT_TOTAL
