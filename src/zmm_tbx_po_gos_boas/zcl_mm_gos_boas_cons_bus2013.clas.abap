"! <p class="shorttext synchronized" lang="en">CA-TBX: MM GOS: Schedulg. agreem. consumer to select attachm</p>
CLASS zcl_mm_gos_boas_cons_bus2013 DEFINITION PUBLIC
...
*   i n s t a n c e   a t t r i b u t e s
    DATA:
*     t a b l e s
      "! <p class="shorttext synchronized" lang="en">Scheduling agreement items</p>
      mt_items TYPE bapimeout_t_item READ-ONLY,

*     s t r u c t u r e s
      "! <p class="shorttext synchronized" lang="en">Scheduling agreement header</p>
...
CLASS ZCL_MM_GOS_BOAS_CONS_BUS2013 IMPLEMENTATION.
  ...
  METHOD activate_service.
    ...
    check_rel_doc_type_to_doc_cat( iv_bstyp = c_bstyp_l
  ...
  METHOD constructor.
    ...
    "Get document type of scheduling agreement
    ...
    DATA(lx_error) =
         CAST zcx_mm_gos_boas(
                zcx_ca_error=>create_exception(
                         ...
                         iv_function = 'BAPI_SAG_GETDETAIL'
