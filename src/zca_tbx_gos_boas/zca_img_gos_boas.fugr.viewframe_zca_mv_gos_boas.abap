*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCA_MV_GOS_BOAS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCA_MV_GOS_BOAS     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCA_MV_GOS_BOAS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCA_MV_GOS_BOAS_EXTRACT
TOTAL = ZCA_MV_GOS_BOAS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCA_MV_GOS_BOAS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCA_MV_GOS_BOAS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCA_MV_GOS_BOAS_EXTRACT
TOTAL = ZCA_MV_GOS_BOAS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCA_MV_GOS_BOAS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCA_MV_GOS_BOAS'
...
TOTAL = ZCA_MV_GOS_BOAS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCA_MV_GOS_BOAS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCA_MV_GOS_BOAS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZCA_MV_GOS_BOAS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZCA_MV_GOS_BOAS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCA_MV_GOS_BOAS_EXTRACT
TOTAL = ZCA_MV_GOS_BOAS_TOTAL
